...
import 'package:nodemobile/view/modules/perakende/subpages/malzeme_fisi_olustur/viewmodel/fis_icerik_viewmodel.dart';
...
class FisIcerikView extends ConsumerStatefulWidget {
  FisBasligiModel fisBasligiModel;
  FisIcerikView({Key? key, required this.fisBasligiModel}) : super(key: key);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        floatingActionButton: widget.fisBasligiModel.goldenSync == 0
            ...
            : null,
        appBar: AppBar(
          title: const Text('Malzeme fişi içeriği'),
          centerTitle: true,
        ),
        body: Padding(
